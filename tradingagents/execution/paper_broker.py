...
class PaperBroker(BaseBroker):
    ...
    def submit_short_sell(self, symbol: str, qty: int, price: float,
        ...
        self.cash += qty * price  # Short sale proceeds (held as collateral)
    ...
    def submit_cover(self, symbol: str, qty: int, price: float,
        ...
        # Buy back shares at cover price (return proceeds to market)
        self.cash -= cover_qty * price
    ...
    def reconstruct_from_trades(self, open_trades: list[dict]) -> None:
        ...
        for t in open_trades:
            ...
            if direction == "short":
                ...
                self.margin_used += required_margin
                self.cash += shares * avg_price  # Short sale proceeds
