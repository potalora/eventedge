...
DEFAULT_CONFIG = {
    ...
    "autoresearch": {
        ...
        # gen_002 risk-discipline knobs. ACTIVE values for gen_002 (this branch only;
        # main keeps the baseline 0 / 0.60 / 25.0). Each is read by one component.
        "risk_discipline": {
            "reentry_cooldown_days": 7,         # block re-entry of a stopped name for N days (0 = off)
            "short_conviction_threshold": 0.45, # min LLM conviction for a single-strategy short
            "regime_vix_stressed": 20.0,        # VIX above this => "stressed" regime
        },
    },
}
